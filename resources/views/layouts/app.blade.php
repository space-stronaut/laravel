...
<body>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @guest
                            ...
                            @if (Route::has('register'))
                                <li class="nav-item">
                                    <a class="btn btn-primary register-btn" href="{{ route('register') }}">{{ __('Register') }}</a>
                                </li>
                            @endif
                        @else
    ...
    <footer class="bg-light text-center text-lg-start">
        ...
        <div class="text-center p-3" style="background-color: rgba(0, 0, 0, 0.2)">
          <span class="time"></span> Copyright:
          <a class="text-dark" href="https://mdbootstrap.com/">oZone Creative Team</a>
        </div>
        <!-- Copyright -->
      </footer>
